export const holidays2026 = [
    ...
    { date: '2026-05-25', name: '대체공휴일(부처님 오신 날)', isSubstitute: true },
    ...
    { date: '2026-09-28', name: '대체공휴일(추석)', isSubstitute: true },
...
export const getHolidaysByMonth = (month) => {
    return holidays2026.filter(h => new Date(h.date).getMonth() === month);
};
